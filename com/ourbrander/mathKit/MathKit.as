package com.ourbrander.mathKit 
{
	/**
	 * ...
	...
	public class MathKit
	{
		...
		public static function isInsidePolygon(x1, y1, polygon:Array):Boolean {
		...
		public static function getIntersectionBetweenLineAndPolygon(x1, y1, x2, y2, polygon:Array, line:uint = 0):Array {
		...
		public static function Line2Polygon(x1, y1, x2, y2, polygon:Array, line:uint = 0,getPoint:Boolean=true):Array {
			//返回一个数组，这个数组包括下面的 point,还要包括一组分析数据。在线段或直线与多边形交点的两边，交点的分布数量。
			//var polygon:Array = polygon
		...
		public static function segment2Polygon(x1, y1, x2, y2, polygon:Array):Array {
			var len:uint = polygon.length
			var point:Array = []; //[[x,y],[x,y],[x,y]]依次是交点、交点所在边的顶点A，顶点B
			var index:uint=0
		...
		//这个是一旦检测到碰撞就返回碰撞结果。
		public static function segment2Polygon2(x1, y1, x2, y2, polygon:Array):Array {
			var len:uint = polygon.length
			var g:uint
			var p:Array;
			for (var i :uint = 0; i < len; i += 2 ) {

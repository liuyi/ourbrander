package com.ourbrander.webObj.component.scrollBar{
	...
	*/
	...
	public class octScrollbar extends MovieClip {
		//视图设定
		...
		public function octScrollbar(target:*,tmpDirection:String=null) {//构造函数
		...
		protected function removedFromStage(e:Event):void 
		{
			...
			_downBtn.removeEventListener(MouseEvent.MOUSE_DOWN,function(){_downBtn.addEventListener(Event.ENTER_FRAME,rollDown);});
			_downBtn.removeEventListener(MouseEvent.MOUSE_UP,function (){_downBtn.removeEventListener(Event.ENTER_FRAME,rollDown)});
			
			_upBtn.removeEventListener(MouseEvent.MOUSE_DOWN,function(){_upBtn.addEventListener(Event.ENTER_FRAME,rollUp);});
			_upBtn.removeEventListener(MouseEvent.MOUSE_UP,function (){_upBtn.removeEventListener(Event.ENTER_FRAME,rollUp)});
